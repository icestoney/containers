...
using s21_vector = s21::vector<std::pair<s21_set::iterator, bool>>;
using std::cout;
...
TEST(set, insert_many) {
  s21_set s1 = {1, 2, 3, 4, 5};
  std_set s_std = {1, 2, 3, 4, 5};
  s21_vector vec = s1.insert_many(10, 3, 5, 16);
  s21::vector<int> check = {10, 0, 0, 16};
