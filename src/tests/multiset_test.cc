...
using s21_vector = s21::vector<std::pair<s21_multiset::iterator, bool>>;
using std::cout;
...
TEST(multiset, equal_range) {
  ...
  ms1_range = ms1.equal_range(0);
  ms_std_range = ms_std.equal_range(0);
...
TEST(multiset, insert_many) {
  s21_multiset ms1 = {1, 2, 3, 4, 5, 1, 2, 3};
  std_multiset ms_std = {1, 2, 3, 4, 5, 1, 2, 3};
  s21_vector vec = ms1.insert_many(10, 3, 5, 16);
  s21::vector<int> check = {10, 3, 5, 16};

  int i = 0;
  for (auto it_vec = vec.begin(); it_vec != vec.end(); it_vec++, i++) {
    EXPECT_EQ(*((*it_vec).first), check[i]);
...
TEST(multiset, insert_many_empty) {
  s21_multiset ms1 = {1, 2, 3, 4, 5, 1, 2, 3};
  std_multiset ms_std = {1, 2, 3, 4, 5, 1, 2, 3};
  s21_vector vec = ms1.insert_many();
  s21::vector<int> check = {};
